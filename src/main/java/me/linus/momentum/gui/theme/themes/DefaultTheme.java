...
public class DefaultTheme extends Theme implements MixinInterface {
    ...
    public void drawTitles(String name, int x, int y) {
        GuiScreen.drawRect(x - 2, y, (x + width + 2), y + height, Color.COLOR);
    ...
    private static void drawCheckbox(Checkbox checkbox, int x, int y) {
        ...
        GuiScreen.drawRect(x + 4, y + height + (boost * height) + 1, (x + width) - 1, (y + height) + height + (boost * height), checkbox.getValue() ? Color.COLOR : 0xCC232323);
    ...
    private static void drawSubCheckbox(SubCheckbox sc, int x, int y) {
        ...
        GuiScreen.drawRect(x, y + height + (boost * height), x + width, y + height*2 + (boost * height), 0x99202020);
        GuiScreen.drawRect(x + 8, y + height + (boost * height) + 1, (x + width) - 1, (y + height) + height + (boost * height), sc.getValue() ? Color.COLOR : 0xCC232323);
    ...
    private static void drawSlider(Slider sl, int x, int y) {
        ...
        GuiScreen.drawRect(x, y + height + (boost * height), x + width, y + height*2 + (boost * height), 0x99202020);
        GuiScreen.drawRect(x + 4, y + height + (boost * height) + 1, (x + width) - 1, (y + height) + height + (boost * height), 0xCC232323);
        GuiScreen.drawRect(x + 4, y + height + (boost * height) + 1, x + 4 + (rectAdd > width - 1 ? (width - 5) : rectAdd), (y + height) + height + (boost * height), Color.COLOR);
    ...
    private static void drawSubSlider(SubSlider ssl, int x, int y) {
        ...
        GuiScreen.drawRect(x, y + height + (boost * height), x + width, y + height*2 + (boost * height), 0x99202020);
        GuiScreen.drawRect(x + 8, y + height + (boost * height) + 1, (x + width) - 1, (y + height) + height + (boost * height), 0xCC232323);
        GuiScreen.drawRect(x + 8, y + height + (boost * height) + 1, x + 8 + (rectAdd > width ? (width-8) : rectAdd), (y + height) + height + (boost * height), Color.COLOR);
