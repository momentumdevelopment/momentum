...
public class Time extends HUDComponent {
    ...
    public void renderComponent() {
        ...
        FontUtil.drawStringWithShadow(time, HUDComponentManager.getComponentByName("Time").getX(), HUDComponentManager.getComponentByName("Time").getY(), new Color(255, 255, 255).getRGB());
