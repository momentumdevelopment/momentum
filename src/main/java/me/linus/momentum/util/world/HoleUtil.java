...
public class HoleUtil implements MixinInterface {
    ...
    public static boolean isVoidHole(BlockPos blockPos) {
        return blockPos.getY() == 0 && mc.world.getBlockState(blockPos).getBlock() == Blocks.AIR;
    }

    public static boolean IsObbyHole(BlockPos blockPos) {
        return !(HoleESP.mc.world.getBlockState(blockPos.add(0, 1, 0)).getBlock() != Blocks.AIR || IsBRockHole(blockPos) || HoleESP.mc.world.getBlockState(blockPos.add(0, 0, 0)).getBlock() != Blocks.AIR || HoleESP.mc.world.getBlockState(blockPos.add(0, 2, 0)).getBlock() != Blocks.AIR || HoleESP.mc.world.getBlockState(blockPos.add(0, 0, -1)).getBlock() != Blocks.OBSIDIAN && HoleESP.mc.world.getBlockState(blockPos.add(0, 0, -1)).getBlock() != Blocks.BEDROCK || HoleESP.mc.world.getBlockState(blockPos.add(1, 0, 0)).getBlock() != Blocks.OBSIDIAN && HoleESP.mc.world.getBlockState(blockPos.add(1, 0, 0)).getBlock() != Blocks.BEDROCK || HoleESP.mc.world.getBlockState(blockPos.add(-1, 0, 0)).getBlock() != Blocks.OBSIDIAN && HoleESP.mc.world.getBlockState(blockPos.add(-1, 0, 0)).getBlock() != Blocks.BEDROCK || HoleESP.mc.world.getBlockState(blockPos.add(0, 0, 1)).getBlock() != Blocks.OBSIDIAN && HoleESP.mc.world.getBlockState(blockPos.add(0, 0, 1)).getBlock() != Blocks.BEDROCK || HoleESP.mc.world.getBlockState(blockPos.add(0.5, 0.5, 0.5)).getBlock() != Blocks.AIR || HoleESP.mc.world.getBlockState(blockPos.add(0, -1, 0)).getBlock() != Blocks.OBSIDIAN && HoleESP.mc.world.getBlockState(blockPos.add(0, -1, 0)).getBlock() != Blocks.BEDROCK);
    }
