...
public class StashFinder extends Module {
    ...
    private static Mode mode = new Mode("Mode", "Find", "Log", "Both");
    private static Checkbox chests = new Checkbox("Chests", true);
    private static Checkbox shulkers = new Checkbox("Shulkers", true);

    private static Checkbox rotate = new Checkbox("Rotate", true);
    private static SubSlider delay = new SubSlider(rotate, "Delay Before Rotate", 0.0D, 120.0D, 600.0D, 0);
